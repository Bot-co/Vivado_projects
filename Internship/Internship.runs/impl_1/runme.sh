...
HD_PWD='C:/Users/prave/Vivado_projects/Internship/Internship.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log dynamic_mac.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source dynamic_mac.tcl -notrace
