...
HD_PWD='C:/Users/prave/Vivado_projects/Internship/Internship.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dynamic_mac.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dynamic_mac.tcl
