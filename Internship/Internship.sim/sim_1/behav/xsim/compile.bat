...
REM
REM Generated by Vivado on Sun May 31 16:37:54 +0530 2026
...
echo "xvlog --incr --relax -prj tb_dynamic_mac_vlog.prj"
call xvlog  --incr --relax -prj tb_dynamic_mac_vlog.prj -log xvlog.log
