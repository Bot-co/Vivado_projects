...
HD_PWD='C:/Users/prave/Vivado_projects/StackelMAC/StackelMAC.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log exact_mac_baseline.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source exact_mac_baseline.tcl
