...
REM
REM Generated by Vivado on Sun Apr 12 22:31:53 +0530 2026
...
echo "xvlog --incr --relax -prj tb_universal_adder_vlog.prj"
call xvlog  --incr --relax -prj tb_universal_adder_vlog.prj -log xvlog.log
