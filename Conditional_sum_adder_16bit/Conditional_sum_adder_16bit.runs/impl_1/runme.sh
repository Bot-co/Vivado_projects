...
HD_PWD='C:/Users/prave/Vivado_projects/Conditional_sum_adder_16bit/Conditional_sum_adder_16bit.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log cosa_16bit_block_ripple.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source cosa_16bit_block_ripple.tcl -notrace
