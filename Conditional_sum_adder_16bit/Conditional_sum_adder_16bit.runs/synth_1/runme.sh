...
HD_PWD='C:/Users/prave/Vivado_projects/Conditional_sum_adder_16bit/Conditional_sum_adder_16bit.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cosa_16bit_block_ripple.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cosa_16bit_block_ripple.tcl
