...
REM
REM Generated by Vivado on Sat Apr 11 18:08:27 +0530 2026
...
echo "xvlog --incr --relax -prj tb_multiplier_seq_vlog.prj"
call xvlog  --incr --relax -prj tb_multiplier_seq_vlog.prj -log xvlog.log
