...
HD_PWD='C:/Users/prave/Vivado_projects/multiplier_sequential/multiplier_sequential.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log multiplier_seq.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source multiplier_seq.tcl
