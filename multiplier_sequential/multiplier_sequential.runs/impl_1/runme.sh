...
HD_PWD='C:/Users/prave/Vivado_projects/multiplier_sequential/multiplier_sequential.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log multiplier_seq.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source multiplier_seq.tcl -notrace
