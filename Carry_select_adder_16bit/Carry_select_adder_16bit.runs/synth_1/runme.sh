...
HD_PWD='C:/Users/prave/Vivado_projects/Carry_select_adder_16bit/Carry_select_adder_16bit.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log carry_select_adder_16bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source carry_select_adder_16bit.tcl
