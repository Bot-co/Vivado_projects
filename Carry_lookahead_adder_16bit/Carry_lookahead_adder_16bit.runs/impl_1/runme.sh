...
HD_PWD='C:/Users/prave/Vivado_projects/Carry_lookahead_adder_16bit/Carry_lookahead_adder_16bit.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log cla16bit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source cla16bit.tcl -notrace
