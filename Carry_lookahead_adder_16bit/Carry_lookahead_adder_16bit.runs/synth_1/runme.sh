...
HD_PWD='C:/Users/prave/Vivado_projects/Carry_lookahead_adder_16bit/Carry_lookahead_adder_16bit.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cla16bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cla16bit.tcl
