...
REM
REM Generated by Vivado on Sat Mar 07 18:43:40 +0530 2026
...
echo "xvlog --incr --relax -prj tb_cla32bit_vlog.prj"
call xvlog  --incr --relax -prj tb_cla32bit_vlog.prj -log xvlog.log
